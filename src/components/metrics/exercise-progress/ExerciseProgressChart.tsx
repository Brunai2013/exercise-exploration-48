...
const ExerciseProgressChart: React.FC<ExerciseProgressChartProps> = ({ 
            ...
            <HoverCard>
              ...
              <HoverCardContent className="w-80">
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    Track your progress on exercises over time. 
                    See how your weights and reps have changed.
                  </p>
                </div>
              </HoverCardContent>
            </HoverCard>
  ...
  // Prepare data for the weight trends chart - group by exercise
  const uniqueExercises = getUniqueExercises(data);
  ...
  // Prepare summary data of max weights and reps per exercise
  const exerciseSummary = useMemo(() => {
    ...
    uniqueExercises.forEach(exercise => {
      ...
      const maxWeight = Math.max(...exerciseData.map(item => item.weight));
      const maxReps = Math.max(...exerciseData.map(item => item.reps));
